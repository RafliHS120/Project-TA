...
Tahap awal analisis dilakukan melalui pra-pengolahan data untuk menyiapkan mikrodata sebelum proses klasterisasi. Tahap ini meliputi penggabungan (merging) file VSEN25.K dan VSEN25.KP berdasarkan identitas rumah tangga, penyaringan rumah tangga di Provinsi DKI Jakarta, pembersihan data, dan penetapan variabel pembentuk klaster serta variabel profiling. Pembersihan data dilakukan dengan memeriksa data hilang pada variabel utama dan mendeteksi pencilan pada variabel pengeluaran agar tidak menggeser pusat klaster (centroid) secara ekstrem. Variabel pembentuk klaster terdiri atas pengeluaran listrik rumah tangga ⟨X1⟩, total pengeluaran rumah tangga ⟨X2⟩, ukuran rumah tangga ⟨X3⟩, dan tingkat pendidikan KRT ⟨X4⟩. Adapun kepemilikan air conditioner (AC) tidak digunakan dalam pembentukan klaster, tetapi digunakan pada tahap profiling untuk membantu interpretasi karakter masing-masing klaster.
