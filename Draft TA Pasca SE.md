...
Interpretasi hasil dalam bab ini perlu dibaca dengan memperhatikan bahwa konsumsi listrik yang digunakan bukan merupakan kWh aktual hasil pencatatan meter rumah tangga. Berdasarkan hasil pemeriksaan data, informasi kWh aktual tidak tersedia secara memadai sehingga konsumsi listrik rumah tangga diestimasi dari pengeluaran listrik bulanan yang dikonversi menggunakan tarif rata-rata listrik rumah tangga DKI Jakarta berdasarkan Statistik PLN 2024. Oleh karena itu, seluruh penyebutan konsumsi listrik dalam pembahasan ini merujuk pada estimasi konsumsi listrik.

## 4.1 Deskripsi Data Hasil Pengolahan

Data yang digunakan dalam penelitian ini berasal dari mikrodata Susenas Maret 2025 untuk Provinsi DKI Jakarta. Tahap awal pengolahan dilakukan dengan menggabungkan informasi rumah tangga, karakteristik individu kepala rumah tangga, serta pengeluaran nonmakanan rumah tangga berdasarkan identitas rumah tangga. Hasil pemeriksaan awal menunjukkan bahwa seluruh sumber data yang digunakan memiliki cakupan rumah tangga yang konsisten, yaitu sebanyak 5.079 rumah tangga unik. Konsistensi jumlah rumah tangga pada setiap sumber data menunjukkan bahwa proses penggabungan data dapat dilakukan tanpa kehilangan unit rumah tangga pada tahap awal.

Pemeriksaan terhadap struktur rumah tangga juga dilakukan untuk memastikan bahwa setiap rumah tangga memiliki kepala rumah tangga yang dapat digunakan sebagai dasar pembentukan variabel pendidikan KRT. Hasil diagnostik menunjukkan bahwa identifikasi kepala rumah tangga dapat dilakukan pada data individu. Variabel pendidikan KRT kemudian dikonversi ke dalam tahun sekolah ekuivalen. Karena informasi ijazah tertinggi tidak tersedia pada data hasil pengolahan, pendekatan yang digunakan adalah jenjang pendidikan tertinggi yang sedang atau pernah diikuti. Berdasarkan hasil recode, terdapat 85 rumah tangga atau sekitar 1,67 persen yang tidak dapat dikonversi ke dalam tahun sekolah ekuivalen. Proporsi ini relatif kecil sehingga observasi tersebut dikeluarkan dari analisis utama.

Tahap berikutnya adalah pemeriksaan terhadap variabel konsumsi listrik. Hasil pemeriksaan menunjukkan bahwa informasi kWh aktual tidak terisi secara memadai karena seluruh nilai kWh tercatat bernilai nol. Sebaliknya, informasi pengeluaran listrik bulanan tersedia untuk seluruh rumah tangga. Oleh karena itu, penelitian ini tidak menggunakan kWh aktual sebagai variabel utama, melainkan membentuk estimasi konsumsi listrik dari pengeluaran listrik bulanan yang dibagi dengan tarif listrik acuan sebesar Rp1.493,62/kWh. Keputusan ini dilakukan agar variabel konsumsi listrik tetap dapat dianalisis dalam satuan kWh, tetapi dengan catatan bahwa nilai tersebut merupakan estimasi berbasis pengeluaran.

Berdasarkan hasil tersebut, sumber konsumsi listrik final yang digunakan dalam penelitian ini adalah estimasi konsumsi listrik berbasis pengeluaran listrik. Keputusan ini juga menjaga konsistensi analisis karena setiap rumah tangga memiliki nilai pengeluaran listrik bulanan yang valid. Selain itu, pengeluaran nonmakanan selain listrik dibentuk dengan mengurangi pengeluaran listrik dari total pengeluaran nonmakanan. Langkah ini dilakukan untuk menghindari tumpang tindih langsung antara variabel konsumsi listrik dan indikator kapasitas ekonomi rumah tangga.

Setelah proses penggabungan, pembentukan variabel, dan pembersihan data dilakukan, jumlah observasi yang digunakan dalam analisis utama adalah 4.994 rumah tangga dari total awal 5.079 rumah tangga. Seluruh 85 observasi yang dikeluarkan berasal dari rumah tangga dengan informasi pendidikan kepala rumah tangga yang tidak dapat dikonversi ke dalam tahun sekolah ekuivalen. Kriteria pembersihan lain yang diterapkan, yaitu kelengkapan bobot rumah tangga, kewajaran nilai estimasi konsumsi listrik dan pengeluaran listrik, kelengkapan pengeluaran nonmakanan, ukuran rumah tangga, serta informasi kepemilikan air conditioner, tidak menggugurkan observasi tambahan. Dengan demikian, data akhir yang digunakan dalam analisis klaster telah memuat variabel pembentuk klaster secara lengkap, yaitu estimasi konsumsi listrik, pengeluaran nonmakanan selain listrik, ukuran rumah tangga, dan pendidikan KRT.
...
## 4.2 Analisis Deskriptif Karakteristik Rumah Tangga

Tahap ini menyajikan gambaran umum karakteristik rumah tangga di Provinsi DKI Jakarta berdasarkan variabel penelitian. Analisis dilakukan pada data hasil cleaning, yang memuat 4.994 rumah tangga setelah mengeluarkan observasi dengan informasi pendidikan kepala rumah tangga tidak valid atau data hilang pada variabel utama.
